...
* 截止目前，Edge 用户可以从 Microsoft Store 中安装完整版；若未来更新为 Lite 版本，请按照下述步骤安装；
* Edge / Chrome 用户请按照下述步骤安装；
...
如您遇到扩展无法安装或无法启用的问题（常见于 Google Chrome 86+），请按照以下步骤操作：
...
请参照[Microsoft 官网](https://learn.microsoft.com/zh-cn/deployedge/microsoft-edge-manage-extensions-policies#allow-or-block-extensions-in-group-policy)，将`jhigoaelcgmfbidkocglkcnhmfacajle`加入到`ExtensionInstallAllowlist`中
